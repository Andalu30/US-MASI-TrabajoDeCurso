...
\\En este paso 3, donde nos encontremos un 0, vamos a hacer una línea para `eliminarlos'. Nos sale 4 líneas (3 horizontales y 1 vertical) y como nuestra matriz es 4x4, es decir, tenemos 4 estudiantes para 4 puestos de trabajo, habríamos acabado.\\
...
Al igual que en el Paso 2 del apartado anterior ahora en vez el número mas chico de cada fila se cogería el número más chico de cada columna y se le restaría. Obviando como antes si hubiera ceros porque al restarlo se quedarían igual tanto filas como columnas.
